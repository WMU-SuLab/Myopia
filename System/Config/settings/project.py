...
DATA_DIR_PATH_LIST = [
    ...
    # 数据库导入数据文件夹
    IMPORT_DATA_DIR_PATH, IMPORT_JSON_DATA_DIR_PATH, IMPORT_SQL_DATA_DIR_PATH, IMPORT_XLSX_DATA_DIR_PATH,
    IMPORT_XLS_DATA_DIR_PATH, IMPORT_CSV_DATA_DIR_PATH,
    # 用户数据文件夹
    USER_DATA_DIR_PATH,
...
# 阿里云API配置
ALIBABACLOUD_ACCESS_KEY_ID = os.environ.get('ALIBABACLOUD_ACCESS_KEY_ID', '')
ALIBABACLOUD_ACCESS_KEY_SECRET = os.environ.get('ALIBABACLOUD_ACCESS_KEY_SECRET', '')
